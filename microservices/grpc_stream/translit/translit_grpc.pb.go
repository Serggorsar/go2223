...
// All implementations should embed UnimplementedTransliterationServer
// for forward compatibility
type TransliterationServer interface {
	EnRu(Transliteration_EnRuServer) error
}

// UnimplementedTransliterationServer should be embedded to have forward compatible implementations.
